...
def getBaseModel(**kwargs):
	...
	custom_out= [ Dense(100, activation="sigmoid", kernel_regularizer=l1_l2(l1=1e-5, l2=1e-4), bias_regularizer=l2(l2N))(sc) for i in range(combN) ]
	#print("len of custom_out: ",len(custom_out));input("wait..")
